...
non_names=("al" "bestimmt" "bin" "da" "de" "dela" "do" "el" "kein" "keinen" "la" "nicht" "noch" "noche" "oğlu" "Vorname" "Familienname" "\(Vorname[^;]*" "und" "ohne" "von" "van" "zur" "der" "del" "wegen" "Vornamen!")
